...
ARG BUILD_NUMBER=0
ARG VITE_APP_NAME=AI Canvas
ARG VITE_STUDIO_VIDEO_PROVIDER=kie
ARG VITE_STUDIO_VIDEO_MODEL=bytedance/seedance-2
ARG VITE_STUDIO_VIDEO_MODEL_NAME=Seedance 2.0
ENV GIT_COMMIT_HASH=$GIT_COMMIT_HASH \
    BUILD_NUMBER=$BUILD_NUMBER \
    VITE_APP_NAME=$VITE_APP_NAME \
    VITE_STUDIO_VIDEO_PROVIDER=$VITE_STUDIO_VIDEO_PROVIDER \
    VITE_STUDIO_VIDEO_MODEL=$VITE_STUDIO_VIDEO_MODEL \
    VITE_STUDIO_VIDEO_MODEL_NAME=$VITE_STUDIO_VIDEO_MODEL_NAME
