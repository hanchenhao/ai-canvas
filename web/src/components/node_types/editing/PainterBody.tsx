        ...
        <FlexRow className="bottom-row sliders-row" align="center" gap={0.5}>
          <div className="slider-field">
            <NumberInput
              ...
              nodeId={id}
              name="size"
              description={t("canvas:imageEditing.brushSize")}
              value={brushSize}
              min={1}
              max={256}
              size="small"
          ...
          <div className="slider-field">
            <NumberInput
              ...
              nodeId={id}
              name="opacity"
              description={t("canvas:imageEditing.brushOpacity")}
              value={brushOpacity}
              min={0}
              max={1}
              size="small"
        ...
        <FlexRow className="bottom-row canvas-row" align="center" gap={0.5}>
          <div className="dim-field">
            <NumberInput
              ...
              nodeId={id}
              name="canvas width"
              description={t("canvas:imageEditing.canvasWidthPx")}
              value={configuredW}
              min={1}
              max={4096}
              size="small"
          ...
          <div className="dim-field">
            <NumberInput
              ...
              nodeId={id}
              name="canvas height"
              description={t("canvas:imageEditing.canvasHeightPx")}
              value={configuredH}
              min={1}
              max={4096}
              size="small"
        ...
        <FlexRow className="bottom-row" align="center" gap={0.5}>
          <div className="slider-field">
            <NumberInput
              ...
              description={t("canvas:imageEditing.bgImageOpacity")}
              value={bgFade}
              min={0}
              max={1}
              size="small"
